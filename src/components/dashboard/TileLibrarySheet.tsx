  ...
  return (
    <Drawer.Root open={open} onOpenChange={onOpenChange}>
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed bottom-0 left-0 right-0 z-[210] max-h-[70vh] rounded-t-[20px] border border-[var(--border)] bg-[var(--bg-elevated)] p-5">
          ...
          <p className="mt-1 text-[14px] text-[var(--text-secondary)]">Tap a tile to add it to the bottom of your dashboard.</p>
