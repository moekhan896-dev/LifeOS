...
function Skeleton({ className = '' }: { className?: string }) {
  return (
    <div className={`animate-pulse rounded-[10px] bg-[var(--surface)] ${className}`} />
  )
}
      ...
      {!loaded ? (
        ...
        <PageTransition key="dashboard">
          <div className="space-y-4 pb-24">
            ...
            {/* ── Sticky Top Bar ── */}
            <motion.div
              className="sticky top-0 z-30 -mx-4 px-4 py-3 flex flex-col gap-2 md:flex-row md:items-center md:justify-between"
              style={{
            ...
            {/* ── THE ONE THING ── */}
            <motion.div
              className="relative rounded-[12px] p-[1px] cursor-pointer group"
              style={{
                backgroundImage: 'linear-gradient(135deg, var(--accent), var(--cyan), var(--accent))',
            ...
            >
              <div className="bg-[var(--bg)] rounded-[11px] p-4">
                <span className="label text-[10px] tracking-widest text-[var(--accent)]">THE ONE THING</span>
                <p className="text-[11px] text-[var(--text-dim)] mt-0.5 mb-2">
                  If you do only one thing today, do this.
                </p>
                <p className="data text-lg font-bold text-[var(--text)]">
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <StaggerItem>
                ...
                >
                  ...
                  <div className="data text-3xl font-bold text-[var(--accent)] mt-1">{daysUntilTarget()}</div>
              ...
              <StaggerItem>
                ...
                >
                  ...
                  <div className="mt-2 pt-2 border-t border-[var(--border)] flex items-center justify-between">
                    ...
                    <span className="data text-base font-bold text-[var(--rose)]">-${coiTotal.toLocaleString()}/mo</span>
                  </div>
                </motion.div>
              </StaggerItem>
            </StaggerContainer>
            ...
            <StaggerContainer className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-3">
              <StaggerItem className="space-y-2">
                ...
                {activeInsights.length > 0 ? (
                  ...
                  <div className="card bg-[var(--surface)] border border-[var(--border)] rounded-[10px] p-4 text-center text-[12px] text-[var(--text-dim)]">
            ...
            >
              <h2 className="label text-[10px] text-[var(--text-dim)] tracking-widest mb-2">CLIENT FINANCIALS</h2>
            ...
            >
              <h2 className="label text-[10px] text-[var(--text-dim)] tracking-widest mb-2">PLUMBING GMB PROFILES</h2>
              <StaggerContainer
                className="gap-3"
